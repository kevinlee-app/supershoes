...
Color grayButtonColor = Color(0xff39374B);
Color subtitleColor = Color(0xff504f5e);
Color unselectedColor = Color(0xff808191);
Color transparentColor = Colors.transparent;
Color blackColor = Color(0xff2E2E2E);
Color shoesBackground = Color(0xffECEDEF);
...
TextStyle highlightTextStyle = GoogleFonts.poppins(color: backgroundColor5, fontWeight: medium);
